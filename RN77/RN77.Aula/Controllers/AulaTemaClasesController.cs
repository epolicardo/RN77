...
namespace RN77.Aula.Controllers
{
    ...
    public class AulaTemaClasesController : ControllerBase
    {
        ...
        // }
        [HttpPut("{id}")]
        public async Task<IActionResult> PutAulaTemaClases(int id, [FromBody] AulaTemaClasesViewModel aulatemaclaseViewModel)
        {

            var entity = await this.context.Set<AulaTemaClases>().FindAsync(id);
            entity.Unidad = aulatemaclaseViewModel.Unidad;
